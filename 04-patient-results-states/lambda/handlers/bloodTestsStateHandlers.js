...
var patientIdentificateStateHandlers = Alexa.CreateStateHandler(constants.states.BLOOD, {
  ...
  'AMAZON.YesIntent': function () {
    this.attributes['state'] = constants.states.PATIENT;
...
module.exports = bloodReportsStateHandlers;
