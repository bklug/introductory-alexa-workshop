...
var patientIdentificationStateHandlers = Alexa.CreateStateHandler(constants.states.PATIENT, {
  ...
  'ReportType': function () {
    ...
    if (bloodReports.indexOf(reportType) > -1) {
      ...
      this.emit(":ask", "What type of diagnostic report would you like? You can x ray, ultrasound or c t scan.", 'You can x ray, ultrasound or c t scan.');
    }
    else {
...
module.exports = patientIdentificationStateHandlers;
